  ...
  content: (
    <>
      ...
      <section id="updates">
        <h2>🚀 Updates</h2>
        <p>
          Keep your MEOW CLI purring 🐾 with the latest features and fixes!
          Update your CLI using: <Code fullWidth>meow update</Code>
          <br></br>
          Want to know what version you're on? Check it with:{" "}
          <Code fullWidth>meow version</Code>. ✨
        </p>
      </section>
      <section id="help">
        <h2>📚 Help and Support</h2>
        <p>
          Stuck? Don't fret! 🆘 Access the comprehensive help guide right from
          your terminal: <Code fullWidth>meow help</Code>
        </p>
      </section>
      <section id="news">
        <h2>📣 Exciting News!</h2>
        <div className="news-card">
          <p>
            Big news for our Neko-CLI community! 🎉 We're thrilled to announce
            that <strong>24/7 phone support</strong> will be available starting{" "}
            <strong>August 20, 2025</strong>! 📞
          </p>
          <p className="text-sm text-default-500 mt-2">
            Get ready for round-the-clock assistance whenever you need it. 🕰️
            Stay tuned for more details on the dedicated helpline number. 🔜
          </p>
        </div>
      </section>
      ...
      <section id="contact">
        ...
        <p className="mb-4">
          Need personalized assistance? Fill out the form below and our support
          team will get in touch with you at your preferred time. We're here to
          help you get the most out of Neko-CLI!
        </p>
        <CallbackModal />
      </section>
    </>
            ...
            <>
              ...
              <ModalBody>
                <p className="mb-4 text-sm text-gray-200">
                  Please fill in your details and preferred contact time. Our
