...
export default function Header() {
    ...
    useEffect(() => {
        ...
        if (userAgent.includes("Win")) {
            ...
            setOs("Mac");
        } else if (userAgent.includes("Android")) { // Added Android detection
            setOs("Android");
    ...
    switch (os) {
        case "Windows":
            ...
            buttonHref = "https://github.com/UnStackss/Neko-CLI/releases/download/0.0.1/Neko-CLI-Installer.exe";
            break;
        case "Mac":
            buttonText = "Download Neko-CLI-Installer.dmg";
            buttonHref = "https://github.com/UnStackss/Neko-CLI/releases/download/0.0.1/Neko-CLI-Installer.dmg";
            break;
        case "Linux":
            ...
            <div className="flex flex-row w-fit gap-24 mt-10 flex-wrap justify-center px-5">
                ...
                <div className="flex flex-col gap-8 items-center -order-1 2xl:order-2 2xl:w-auto w-full text-center">
                    <div className="flex flex-col items-center">
                        ...
                        <p className="text-base text-gray-400">The ultimate CLI for modern developers, easy to install and use.</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center">
                        <h1 className="text-xl font-bold m-0 text-primary-300 my-5">Install Neko by line</h1>
