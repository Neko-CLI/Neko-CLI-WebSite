...
export default function CustomCode({ children }) {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText(children)
      .then(() => {
        setIsCopied(true);
        setTimeout(() => setIsCopied(false), 2000); // Ritorna a `false` dopo 2 secondi
  ...
  return (
    <div className="px-3 py-1 h-fit w-fit font-mono m-auto font-normal whitespace-nowrap bg-default/30 text-default-700 text-small rounded-full flex items-center gap-2">
